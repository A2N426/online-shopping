            ...
            <div className="">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <div data-aos="fade-right">
                        <img className="h-auto max-w-full rounded-lg" src="https://cdn.pixabay.com/photo/2023/04/24/10/37/car-7947765_640.jpg" alt="" />
                    </div>
                    <div data-aos="zoom-in-down">
                        <img className="h-auto max-w-full rounded-lg" src="https://media.istockphoto.com/id/1363867603/es/foto/coche-de-juguete.jpg?s=612x612&w=0&k=20&c=hDM4YfAZR4YaVXdWXsF04AoqiJ6vlctA_einpdUoaUk=" alt="" />
                    </div>
                    <div data-aos="fade-left">
                        <img className="h-auto max-w-full rounded-lg" src="https://media.istockphoto.com/id/1316414600/es/foto/manos-de-ni%C3%B1o-jugando-con-coches-de-juguete-multicolores-sobre-fondo-de-madera-blanca.jpg?s=612x612&w=0&k=20&c=sPCb_hn0rs1aIFer76x8HnSKwoM3GdbiYexN3ul3Jz8=" alt="" />
                    </div>
                    <div data-aos="flip-up">
                        <img className="h-auto max-w-full rounded-lg" src="https://images.pexels.com/photos/35967/mini-cooper-auto-model-vehicle.jpg?auto=compress&cs=tinysrgb&w=600" alt="" />
                    </div>
                    <div data-aos="zoom-in-down">

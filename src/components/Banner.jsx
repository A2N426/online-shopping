        ...
        <div data-aos="zoom-out-down">
            <div className="carousel w-full lg:h-[600px] h-[300px]">
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    <img src="https://img.freepik.com/free-photo/closeup-shot-toy-red-wooden-train-wooden-table_181624-21684.jpg?size=626&ext=jpg&ga=GA1.2.24677610.1673838713&semt=ais" className="w-full rounded-lg" />
                    <div className="absolute rounded-xl h-full flex bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] lg:left-0 lg:p-28 p-5 top-0">
                        <div className='text-white lg:space-y-7 lg:w-1/2'>
                            <h1 className='lg:text-6xl text-4xl font-bold'>Affordable Price For Car Servicing</h1>
                            <p>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    <img src="https://img.freepik.com/free-photo/red-car-with-christmas-ball-top_1252-296.jpg?size=626&ext=jpg&ga=GA1.2.24677610.1673838713&semt=ais" className="w-full rounded-lg" />
                    <div className="absolute rounded-xl h-full flex bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] lg:left-0 lg:p-28 p-5 top-0">
                        <div className='text-white lg:space-y-7 lg:w-1/2'>
                            <h1 className='lg:text-6xl text-4xl font-bold'>Affordable Price For Car Servicing</h1>
                            <p>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
                ...
                <div id="slide4" className="carousel-item relative w-full">
                    <img src="https://img.freepik.com/free-photo/small-red-car-toy-kid-child-playing-with-it_114579-7239.jpg?size=626&ext=jpg&ga=GA1.1.24677610.1673838713&semt=ais" className="w-full rounded-lg" />
                    <div className="absolute rounded-xl h-full flex bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] lg:left-0 lg:p-28 p-5 top-0">
                        <div className='text-white lg:space-y-7 lg:w-1/2'>
                            <h1 className='lg:text-6xl text-4xl font-bold'>Affordable Price For Car Servicing</h1>
                            <p>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
